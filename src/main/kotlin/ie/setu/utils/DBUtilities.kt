 ...
 */
fun mapToActivity(it: ResultRow) =
    Activity(
        id = it[Activities.id],
 ...
 */
fun mapToIngredient(it: ResultRow) =
    Ingredient(
 ...
 */
fun mapToRecommendedDailyAllowance(it: ResultRow) =
